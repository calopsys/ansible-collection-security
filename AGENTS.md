...
```
~/git/ansible_collections/calopsys/security
```
...
Use consistent tag naming: `calopsys_security_<action>`

Example:
```yaml
tags: ["calopsys_certbot_install"]
tags: ["calopsys_certbot_configure"]
```

### Variable Naming

- Use `snake_case` for variable names
- Prefix variables with `calopsys_` (e.g., `calopsys_myapp_user`)
